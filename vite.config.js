...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: {
      ...
      // Expo / native stubs
      "@sentry/react-native": resolve(__dirname, "src/stubs/sentry-react-native.ts"),
      "expo-notifications": resolve(__dirname, "src/stubs/expo-notifications.ts"),
      "@stripe/stripe-react-native": resolve(__dirname, "src/stubs/stripe-react-native.tsx"),
      // Path aliases
